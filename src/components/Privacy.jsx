  ...
  return (
    <div className="bg-background text-foreground min-h-screen py-12 px-6 sm:px-16">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6 ">
          At <span className="text-teal-500">DataRepo</span>, your privacy is important to us. This Privacy Policy outlines how we collect, use, protect, and disclose your information when you use our website and services.
        </p>
