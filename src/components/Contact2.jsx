...
const Contact2 = () => (
  <section className="bg-background min-h-screen flex items-center justify-center px-4 py-8">
    <div className="w-full max-w-xl mx-auto">
      {/* Contact Now button */}
      <button className="flex items-center gap-2 bg-[#032219]/80 text-teal-300 text-xs font-medium rounded-xl px-4 py-2 mb-8 shadow float-left">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2">
          <span className="w-6 h-6 flex items-center justify-center rounded-full bg-[#123b3c]/60 text-teal-400">
            +
          </span>
